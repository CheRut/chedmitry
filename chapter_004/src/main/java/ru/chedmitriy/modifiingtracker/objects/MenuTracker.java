...
import ru.chedmitriy.modifiingtracker.models.MenuItem;
...
public class MenuTracker {
    ...
    class MenuAddItem extends MenuItem {
        ...
        @Override public void menuItemInfo(final ConsoleInput cIn, final Tracker tracker) {
            String name = cIn.ask("Please enter"
                    + " the  name of the new Item");
            String description = cIn.ask("Please enter"
    ...
    class MenuShowByFilterItem extends MenuItem {
         ...
         * */
        @Override
        public void menuItemInfo(final ConsoleInput cIn,
