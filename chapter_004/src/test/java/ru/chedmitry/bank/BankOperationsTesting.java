...
public class BankOperationsTesting {
    ...
    public void init() {
        ...
        dataBase.getClient().put(user1,new ArrayList<Account>());
        dataBase.getClient().put(user2,new ArrayList<Account>());
        dataBase.getClient().put(user3,new ArrayList<Account>());
    ...
    public void whenNewUserAdding() {
        int exp = 3;
        assertThat(dataBase.getClient().size(),is(exp));
     ...
     * */
    @Test
    public void whenAccountAddingToUser() {
        dataBase.addAccountToUser(user1,new Account(3000,"1234 5678 9123 4560"));
        String exp = "1234 5678 9123 4560";
        assertThat(dataBase.getClient().get(user1).get(0).getRequisites(),is(exp));
    }
    /**
     ...
     * */
    @Test
    public void whenTryingToGetAccount() {
        dataBase.addAccountToUser(user1,new Account(3000,"1234 5678 9123 4560"));
    ...
    public void whenUserDelete(){
        ...
        int newSizeOfDb = 2;
        assertThat(dataBase.getClient().size(),is(newSizeOfDb));
 ...
 * */
    @Test
    public void whenUserAccountWasDeleted() {
     ...
     * */
    @Test
    public void whenTransferTrying() {
        Account firstUserAccount = new Account(1000,"some requisites");
        Account secondUserAccount = new Account(2000,"new some requisites");
        dataBase.addAccountToUser(user1,firstUserAccount);
        dataBase.addAccountToUser(user1,secondUserAccount);
