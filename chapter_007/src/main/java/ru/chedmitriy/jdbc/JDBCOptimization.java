...
import ru.chedmitriy.jdbc.connection.ConnectOptions;
...
public class JDBCOptimization {
     ...
     * файл логирования
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(JDBCOptimization.class);
    /**
    ...
    public JDBCOptimization(String dbName) {
        ...
        this.connection.connectSQLiteDb(dbName);
